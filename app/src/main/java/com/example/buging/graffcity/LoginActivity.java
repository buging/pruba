...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            SystemUtilities su = new SystemUtilities(getApplication().getApplicationContext());
            String internet;
    ...
    public void button_registro(View view){
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private final String mInternet;
        private String respuesta;

        UserLoginTask(String email, String password, String internet, String r) {
            mEmail = email;
            mPassword = password;
            mInternet = internet;
        }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                if(mInternet=="si") {
                    ...
                    String[] dato = js.getSession(respuesta);
                    ...
                    if(dato[0]!="no") {
                        ...
                        editor.putInt("id", Integer.valueOf(dato[0]));
                        editor.putString("nombre", dato[1]);
                        editor.putString("apellido", dato[2]);
                        editor.putString("nickName", dato[3]);
                        editor.putString("correo", dato[4]);
                        editor.commit();
                        finish();
                        Intent main = new Intent(getApplicationContext(), MainActivity.class);
                        startActivity(main);
                ...
                Toast.makeText(getApplication(),"Usuario y contraseña incorrectos",Toast.LENGTH_SHORT).show();
            }
        }
